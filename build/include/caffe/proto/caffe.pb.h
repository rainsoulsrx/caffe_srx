...
class ShortTermReNormParameter;
class StochasticReNormParameter;
class BatchReNormParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.CenterLossParameter center_loss_param = 502;
  inline bool has_center_loss_param() const;
  inline void clear_center_loss_param();
  static const int kCenterLossParamFieldNumber = 502;
  ...
  // optional .caffe.RankHardLossParameter rank_hard_loss_param = 503;
  inline bool has_rank_hard_loss_param() const;
  inline void clear_rank_hard_loss_param();
  static const int kRankHardLossParamFieldNumber = 503;
  inline const ::caffe::RankHardLossParameter& rank_hard_loss_param() const;
  inline ::caffe::RankHardLossParameter* mutable_rank_hard_loss_param();
  inline ::caffe::RankHardLossParameter* release_rank_hard_loss_param();
  inline void set_allocated_rank_hard_loss_param(::caffe::RankHardLossParameter* rank_hard_loss_param);

  // optional .caffe.BatchReNormParameter batch_renorm_param = 150;
  inline bool has_batch_renorm_param() const;
  inline void clear_batch_renorm_param();
  static const int kBatchRenormParamFieldNumber = 150;
  inline const ::caffe::BatchReNormParameter& batch_renorm_param() const;
  inline ::caffe::BatchReNormParameter* mutable_batch_renorm_param();
  inline ::caffe::BatchReNormParameter* release_batch_renorm_param();
  inline void set_allocated_batch_renorm_param(::caffe::BatchReNormParameter* batch_renorm_param);

  // optional .caffe.StochasticReNormParameter stochastic_renorm_param = 153;
  inline bool has_stochastic_renorm_param() const;
  inline void clear_stochastic_renorm_param();
  static const int kStochasticRenormParamFieldNumber = 153;
  inline const ::caffe::StochasticReNormParameter& stochastic_renorm_param() const;
  inline ::caffe::StochasticReNormParameter* mutable_stochastic_renorm_param();
  inline ::caffe::StochasticReNormParameter* release_stochastic_renorm_param();
  inline void set_allocated_stochastic_renorm_param(::caffe::StochasticReNormParameter* stochastic_renorm_param);

  // optional .caffe.ShortTermReNormParameter short_term_renorm_param = 154;
  inline bool has_short_term_renorm_param() const;
  inline void clear_short_term_renorm_param();
  static const int kShortTermRenormParamFieldNumber = 154;
  inline const ::caffe::ShortTermReNormParameter& short_term_renorm_param() const;
  inline ::caffe::ShortTermReNormParameter* mutable_short_term_renorm_param();
  inline ::caffe::ShortTermReNormParameter* release_short_term_renorm_param();
  inline void set_allocated_short_term_renorm_param(::caffe::ShortTermReNormParameter* short_term_renorm_param);
 ...
 private:
  ...
  inline void set_has_rank_hard_loss_param();
  inline void clear_has_rank_hard_loss_param();
  inline void set_has_batch_renorm_param();
  inline void clear_has_batch_renorm_param();
  inline void set_has_stochastic_renorm_param();
  inline void clear_has_stochastic_renorm_param();
  inline void set_has_short_term_renorm_param();
  inline void clear_has_short_term_renorm_param();
  ...
  ::caffe::RankHardLossParameter* rank_hard_loss_param_;
  ::caffe::BatchReNormParameter* batch_renorm_param_;
  ::caffe::StochasticReNormParameter* stochastic_renorm_param_;
  ::caffe::ShortTermReNormParameter* short_term_renorm_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class ShortTermReNormParameter : public ::google::protobuf::Message {
 public:
  ShortTermReNormParameter();
  virtual ~ShortTermReNormParameter();

  ShortTermReNormParameter(const ShortTermReNormParameter& from);

  inline ShortTermReNormParameter& operator=(const ShortTermReNormParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ShortTermReNormParameter& default_instance();

  void Swap(ShortTermReNormParameter* other);

  // implements Message ----------------------------------------------

  ShortTermReNormParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ShortTermReNormParameter& from);
  void MergeFrom(const ShortTermReNormParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional float short_term_moving_average_fraction = 3 [default = 0.8];
  inline bool has_short_term_moving_average_fraction() const;
  inline void clear_short_term_moving_average_fraction();
  static const int kShortTermMovingAverageFractionFieldNumber = 3;
  inline float short_term_moving_average_fraction() const;
  inline void set_short_term_moving_average_fraction(float value);
  ...
  // optional uint32 iter_size = 5 [default = 1];
  inline bool has_iter_size() const;
  inline void clear_iter_size();
  static const int kIterSizeFieldNumber = 5;
  inline ::google::protobuf::uint32 iter_size() const;
  inline void set_iter_size(::google::protobuf::uint32 value);

  // optional uint32 step_to_init = 6 [default = 1000];
  inline bool has_step_to_init() const;
  inline void clear_step_to_init();
  static const int kStepToInitFieldNumber = 6;
  inline ::google::protobuf::uint32 step_to_init() const;
  inline void set_step_to_init(::google::protobuf::uint32 value);

  // optional float r_max_increase_step = 7 [default = 0.05];
  inline bool has_r_max_increase_step() const;
  inline void clear_r_max_increase_step();
  static const int kRMaxIncreaseStepFieldNumber = 7;
  inline float r_max_increase_step() const;
  inline void set_r_max_increase_step(float value);

  // optional float d_max_increase_step = 8 [default = 0.05];
  inline bool has_d_max_increase_step() const;
  inline void clear_d_max_increase_step();
  static const int kDMaxIncreaseStepFieldNumber = 8;
  inline float d_max_increase_step() const;
  inline void set_d_max_increase_step(float value);

  // @@protoc_insertion_point(class_scope:caffe.ShortTermReNormParameter)
 private:
  ...
  inline void set_has_short_term_moving_average_fraction();
  inline void clear_has_short_term_moving_average_fraction();
  inline void set_has_eps();
  inline void clear_has_eps();
  inline void set_has_iter_size();
  inline void clear_has_iter_size();
  inline void set_has_step_to_init();
  inline void clear_has_step_to_init();
  inline void set_has_r_max_increase_step();
  inline void clear_has_r_max_increase_step();
  inline void set_has_d_max_increase_step();
  inline void clear_has_d_max_increase_step();
  ...
  float short_term_moving_average_fraction_;
  float eps_;
  ::google::protobuf::uint32 iter_size_;
  ::google::protobuf::uint32 step_to_init_;
  float r_max_increase_step_;
  float d_max_increase_step_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static ShortTermReNormParameter* default_instance_;
};
// -------------------------------------------------------------------

class StochasticReNormParameter : public ::google::protobuf::Message {
 public:
  StochasticReNormParameter();
  virtual ~StochasticReNormParameter();

  StochasticReNormParameter(const StochasticReNormParameter& from);

  inline StochasticReNormParameter& operator=(const StochasticReNormParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const StochasticReNormParameter& default_instance();

  void Swap(StochasticReNormParameter* other);

  // implements Message ----------------------------------------------

  StochasticReNormParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const StochasticReNormParameter& from);
  void MergeFrom(const StochasticReNormParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 iter_size = 4 [default = 1];
  inline bool has_iter_size() const;
  inline void clear_iter_size();
  static const int kIterSizeFieldNumber = 4;
  inline ::google::protobuf::uint32 iter_size() const;
  inline void set_iter_size(::google::protobuf::uint32 value);

  // optional uint32 step_to_init = 5 [default = 1000];
  inline bool has_step_to_init() const;
  inline void clear_step_to_init();
  static const int kStepToInitFieldNumber = 5;
  inline ::google::protobuf::uint32 step_to_init() const;
  inline void set_step_to_init(::google::protobuf::uint32 value);

  // optional float r_max_increase_step = 6 [default = 0.05];
  inline bool has_r_max_increase_step() const;
  inline void clear_r_max_increase_step();
  static const int kRMaxIncreaseStepFieldNumber = 6;
  inline float r_max_increase_step() const;
  inline void set_r_max_increase_step(float value);

  // optional float d_max_increase_step = 7 [default = 0.05];
  inline bool has_d_max_increase_step() const;
  inline void clear_d_max_increase_step();
  static const int kDMaxIncreaseStepFieldNumber = 7;
  inline float d_max_increase_step() const;
  inline void set_d_max_increase_step(float value);

  // optional float mean_rng = 8 [default = 0.1];
  inline bool has_mean_rng() const;
  inline void clear_mean_rng();
  static const int kMeanRngFieldNumber = 8;
  inline float mean_rng() const;
  inline void set_mean_rng(float value);

  // optional float std_rng = 9 [default = 0.03];
  inline bool has_std_rng() const;
  inline void clear_std_rng();
  static const int kStdRngFieldNumber = 9;
  inline float std_rng() const;
  inline void set_std_rng(float value);

  // @@protoc_insertion_point(class_scope:caffe.StochasticReNormParameter)
 private:
  inline void set_has_use_global_stats();
  inline void clear_has_use_global_stats();
  inline void set_has_moving_average_fraction();
  ...
  inline void set_has_d_max_increase_step();
  inline void clear_has_d_max_increase_step();
  inline void set_has_mean_rng();
  inline void clear_has_mean_rng();
  inline void set_has_std_rng();
  inline void clear_has_std_rng();
  ...
  void InitAsDefaultInstance();
  static StochasticReNormParameter* default_instance_;
};
// -------------------------------------------------------------------

class BatchReNormParameter : public ::google::protobuf::Message {
 public:
  BatchReNormParameter();
  virtual ~BatchReNormParameter();

  BatchReNormParameter(const BatchReNormParameter& from);

  inline BatchReNormParameter& operator=(const BatchReNormParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const BatchReNormParameter& default_instance();

  void Swap(BatchReNormParameter* other);

  // implements Message ----------------------------------------------

  BatchReNormParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const BatchReNormParameter& from);
  void MergeFrom(const BatchReNormParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 step_to_r_max = 6 [default = 10000];
  inline bool has_step_to_r_max() const;
  inline void clear_step_to_r_max();
  static const int kStepToRMaxFieldNumber = 6;
  inline ::google::protobuf::uint32 step_to_r_max() const;
  inline void set_step_to_r_max(::google::protobuf::uint32 value);

  // optional uint32 step_to_d_max = 7 [default = 10000];
  inline bool has_step_to_d_max() const;
  inline void clear_step_to_d_max();
  static const int kStepToDMaxFieldNumber = 7;
  inline ::google::protobuf::uint32 step_to_d_max() const;
  inline void set_step_to_d_max(::google::protobuf::uint32 value);

  // optional float r_max = 8 [default = 3];
  inline bool has_r_max() const;
  inline void clear_r_max();
  static const int kRMaxFieldNumber = 8;
  inline float r_max() const;
  inline void set_r_max(float value);

  // optional float d_max = 9 [default = 5];
  inline bool has_d_max() const;
  inline void clear_d_max();
  static const int kDMaxFieldNumber = 9;
  inline float d_max() const;
  inline void set_d_max(float value);
 ...
 private:
  ...
  inline void set_has_step_to_init();
  inline void clear_has_step_to_init();
  inline void set_has_step_to_r_max();
  inline void clear_has_step_to_r_max();
  inline void set_has_step_to_d_max();
  inline void clear_has_step_to_d_max();
  inline void set_has_r_max();
  inline void clear_has_r_max();
  inline void set_has_d_max();
  inline void clear_has_d_max();
  ...
  ::google::protobuf::uint32 iter_size_;
  ::google::protobuf::uint32 step_to_init_;
  ::google::protobuf::uint32 step_to_r_max_;
  ::google::protobuf::uint32 step_to_d_max_;
  float r_max_;
  float d_max_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  ...
  void InitAsDefaultInstance();
  static BatchReNormParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 pair_size = 13 [default = 1];
  inline bool has_pair_size() const;
  inline void clear_pair_size();
  static const int kPairSizeFieldNumber = 13;
  inline ::google::protobuf::uint32 pair_size() const;
  inline void set_pair_size(::google::protobuf::uint32 value);

  // optional float num_labels = 14 [default = 1];
  inline bool has_num_labels() const;
  inline void clear_num_labels();
  static const int kNumLabelsFieldNumber = 14;
  inline float num_labels() const;
  inline void set_num_labels(float value);

  // optional float object_scale = 15 [default = 1];
  inline bool has_object_scale() const;
  inline void clear_object_scale();
  static const int kObjectScaleFieldNumber = 15;
  inline float object_scale() const;
  inline void set_object_scale(float value);
 ...
 private:
  ...
  inline void set_has_pair_size();
  inline void clear_has_pair_size();
  ...
  ::std::string* mean_file_;
  ::google::protobuf::uint32 crop_size_;
  ::google::protobuf::uint32 pair_size_;
...
class RankHardLossParameter : public ::google::protobuf::Message {
 public:
  RankHardLossParameter();
  virtual ~RankHardLossParameter();

  RankHardLossParameter(const RankHardLossParameter& from);

  inline RankHardLossParameter& operator=(const RankHardLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RankHardLossParameter& default_instance();

  void Swap(RankHardLossParameter* other);

  // implements Message ----------------------------------------------

  RankHardLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RankHardLossParameter& from);
  void MergeFrom(const RankHardLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_neg_num() const;
  inline void clear_neg_num();
  static const int kNegNumFieldNumber = 1;
  inline ::google::protobuf::uint32 neg_num() const;
  inline void set_neg_num(::google::protobuf::uint32 value);

  // optional uint32 pos_num = 2 [default = 1];
  inline bool has_pos_num() const;
  inline void clear_pos_num();
  static const int kPosNumFieldNumber = 2;
  inline ::google::protobuf::uint32 pos_num() const;
  inline void set_pos_num(::google::protobuf::uint32 value);

  // optional float margin = 3 [default = 0.5];
  inline bool has_margin() const;
  inline void clear_margin();
  ...
  // @@protoc_insertion_point(class_scope:caffe.RankHardLossParameter)
 private:
  inline void set_has_neg_num();
  inline void clear_has_neg_num();
  inline void set_has_pos_num();
  inline void clear_has_pos_num();
  inline void set_has_margin();
  inline void clear_has_margin();
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::uint32 neg_num_;
  ::google::protobuf::uint32 pos_num_;
  float margin_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
  ...
  void InitAsDefaultInstance();
  static RankHardLossParameter* default_instance_;
};
// ===================================================================
...
// optional .caffe.RankHardLossParameter rank_hard_loss_param = 503;
inline bool LayerParameter::has_rank_hard_loss_param() const {
  return (_has_bits_[1] & 0x08000000u) != 0;
}
inline void LayerParameter::set_has_rank_hard_loss_param() {
  _has_bits_[1] |= 0x08000000u;
}
inline void LayerParameter::clear_has_rank_hard_loss_param() {
  _has_bits_[1] &= ~0x08000000u;
}
inline void LayerParameter::clear_rank_hard_loss_param() {
  if (rank_hard_loss_param_ != NULL) rank_hard_loss_param_->::caffe::RankHardLossParameter::Clear();
  clear_has_rank_hard_loss_param();
}
inline const ::caffe::RankHardLossParameter& LayerParameter::rank_hard_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.rank_hard_loss_param)
  return rank_hard_loss_param_ != NULL ? *rank_hard_loss_param_ : *default_instance_->rank_hard_loss_param_;
}
inline ::caffe::RankHardLossParameter* LayerParameter::mutable_rank_hard_loss_param() {
  set_has_rank_hard_loss_param();
  if (rank_hard_loss_param_ == NULL) rank_hard_loss_param_ = new ::caffe::RankHardLossParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.rank_hard_loss_param)
  return rank_hard_loss_param_;
}
inline ::caffe::RankHardLossParameter* LayerParameter::release_rank_hard_loss_param() {
  clear_has_rank_hard_loss_param();
  ::caffe::RankHardLossParameter* temp = rank_hard_loss_param_;
  rank_hard_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_rank_hard_loss_param(::caffe::RankHardLossParameter* rank_hard_loss_param) {
  delete rank_hard_loss_param_;
  rank_hard_loss_param_ = rank_hard_loss_param;
  if (rank_hard_loss_param) {
    set_has_rank_hard_loss_param();
  } else {
    clear_has_rank_hard_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.rank_hard_loss_param)
}

// optional .caffe.BatchReNormParameter batch_renorm_param = 150;
inline bool LayerParameter::has_batch_renorm_param() const {
  return (_has_bits_[1] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_batch_renorm_param() {
  _has_bits_[1] |= 0x10000000u;
}
inline void LayerParameter::clear_has_batch_renorm_param() {
  _has_bits_[1] &= ~0x10000000u;
}
inline void LayerParameter::clear_batch_renorm_param() {
  if (batch_renorm_param_ != NULL) batch_renorm_param_->::caffe::BatchReNormParameter::Clear();
  clear_has_batch_renorm_param();
}
inline const ::caffe::BatchReNormParameter& LayerParameter::batch_renorm_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.batch_renorm_param)
  return batch_renorm_param_ != NULL ? *batch_renorm_param_ : *default_instance_->batch_renorm_param_;
}
inline ::caffe::BatchReNormParameter* LayerParameter::mutable_batch_renorm_param() {
  set_has_batch_renorm_param();
  if (batch_renorm_param_ == NULL) batch_renorm_param_ = new ::caffe::BatchReNormParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.batch_renorm_param)
  return batch_renorm_param_;
}
inline ::caffe::BatchReNormParameter* LayerParameter::release_batch_renorm_param() {
  clear_has_batch_renorm_param();
  ::caffe::BatchReNormParameter* temp = batch_renorm_param_;
  batch_renorm_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_batch_renorm_param(::caffe::BatchReNormParameter* batch_renorm_param) {
  delete batch_renorm_param_;
  batch_renorm_param_ = batch_renorm_param;
  if (batch_renorm_param) {
    set_has_batch_renorm_param();
  } else {
    clear_has_batch_renorm_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.batch_renorm_param)
}

// optional .caffe.StochasticReNormParameter stochastic_renorm_param = 153;
inline bool LayerParameter::has_stochastic_renorm_param() const {
  return (_has_bits_[1] & 0x20000000u) != 0;
}
inline void LayerParameter::set_has_stochastic_renorm_param() {
  _has_bits_[1] |= 0x20000000u;
}
inline void LayerParameter::clear_has_stochastic_renorm_param() {
  _has_bits_[1] &= ~0x20000000u;
}
inline void LayerParameter::clear_stochastic_renorm_param() {
  if (stochastic_renorm_param_ != NULL) stochastic_renorm_param_->::caffe::StochasticReNormParameter::Clear();
  clear_has_stochastic_renorm_param();
}
inline const ::caffe::StochasticReNormParameter& LayerParameter::stochastic_renorm_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.stochastic_renorm_param)
  return stochastic_renorm_param_ != NULL ? *stochastic_renorm_param_ : *default_instance_->stochastic_renorm_param_;
}
inline ::caffe::StochasticReNormParameter* LayerParameter::mutable_stochastic_renorm_param() {
  set_has_stochastic_renorm_param();
  if (stochastic_renorm_param_ == NULL) stochastic_renorm_param_ = new ::caffe::StochasticReNormParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.stochastic_renorm_param)
  return stochastic_renorm_param_;
}
inline ::caffe::StochasticReNormParameter* LayerParameter::release_stochastic_renorm_param() {
  clear_has_stochastic_renorm_param();
  ::caffe::StochasticReNormParameter* temp = stochastic_renorm_param_;
  stochastic_renorm_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_stochastic_renorm_param(::caffe::StochasticReNormParameter* stochastic_renorm_param) {
  delete stochastic_renorm_param_;
  stochastic_renorm_param_ = stochastic_renorm_param;
  if (stochastic_renorm_param) {
    set_has_stochastic_renorm_param();
  } else {
    clear_has_stochastic_renorm_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.stochastic_renorm_param)
}

// optional .caffe.ShortTermReNormParameter short_term_renorm_param = 154;
inline bool LayerParameter::has_short_term_renorm_param() const {
  return (_has_bits_[1] & 0x40000000u) != 0;
}
inline void LayerParameter::set_has_short_term_renorm_param() {
  _has_bits_[1] |= 0x40000000u;
}
inline void LayerParameter::clear_has_short_term_renorm_param() {
  _has_bits_[1] &= ~0x40000000u;
}
inline void LayerParameter::clear_short_term_renorm_param() {
  if (short_term_renorm_param_ != NULL) short_term_renorm_param_->::caffe::ShortTermReNormParameter::Clear();
  clear_has_short_term_renorm_param();
}
inline const ::caffe::ShortTermReNormParameter& LayerParameter::short_term_renorm_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.short_term_renorm_param)
  return short_term_renorm_param_ != NULL ? *short_term_renorm_param_ : *default_instance_->short_term_renorm_param_;
}
inline ::caffe::ShortTermReNormParameter* LayerParameter::mutable_short_term_renorm_param() {
  set_has_short_term_renorm_param();
  if (short_term_renorm_param_ == NULL) short_term_renorm_param_ = new ::caffe::ShortTermReNormParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.short_term_renorm_param)
  return short_term_renorm_param_;
}
inline ::caffe::ShortTermReNormParameter* LayerParameter::release_short_term_renorm_param() {
  clear_has_short_term_renorm_param();
  ::caffe::ShortTermReNormParameter* temp = short_term_renorm_param_;
  short_term_renorm_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_short_term_renorm_param(::caffe::ShortTermReNormParameter* short_term_renorm_param) {
  delete short_term_renorm_param_;
  short_term_renorm_param_ = short_term_renorm_param;
  if (short_term_renorm_param) {
    set_has_short_term_renorm_param();
  } else {
    clear_has_short_term_renorm_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.short_term_renorm_param)
}
...
// optional bool use_global_stats = 1;
inline bool ShortTermReNormParameter::has_use_global_stats() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ShortTermReNormParameter::set_has_use_global_stats() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ShortTermReNormParameter::clear_has_use_global_stats() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ShortTermReNormParameter::clear_use_global_stats() {
  use_global_stats_ = false;
  clear_has_use_global_stats();
}
inline bool ShortTermReNormParameter::use_global_stats() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.use_global_stats)
  return use_global_stats_;
}
inline void ShortTermReNormParameter::set_use_global_stats(bool value) {
  set_has_use_global_stats();
  use_global_stats_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.use_global_stats)
}

// optional float moving_average_fraction = 2 [default = 0.99];
inline bool ShortTermReNormParameter::has_moving_average_fraction() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ShortTermReNormParameter::set_has_moving_average_fraction() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ShortTermReNormParameter::clear_has_moving_average_fraction() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ShortTermReNormParameter::clear_moving_average_fraction() {
  moving_average_fraction_ = 0.99f;
  clear_has_moving_average_fraction();
}
inline float ShortTermReNormParameter::moving_average_fraction() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.moving_average_fraction)
  return moving_average_fraction_;
}
inline void ShortTermReNormParameter::set_moving_average_fraction(float value) {
  set_has_moving_average_fraction();
  moving_average_fraction_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.moving_average_fraction)
}

// optional float short_term_moving_average_fraction = 3 [default = 0.8];
inline bool ShortTermReNormParameter::has_short_term_moving_average_fraction() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ShortTermReNormParameter::set_has_short_term_moving_average_fraction() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ShortTermReNormParameter::clear_has_short_term_moving_average_fraction() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ShortTermReNormParameter::clear_short_term_moving_average_fraction() {
  short_term_moving_average_fraction_ = 0.8f;
  clear_has_short_term_moving_average_fraction();
}
inline float ShortTermReNormParameter::short_term_moving_average_fraction() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.short_term_moving_average_fraction)
  return short_term_moving_average_fraction_;
}
inline void ShortTermReNormParameter::set_short_term_moving_average_fraction(float value) {
  set_has_short_term_moving_average_fraction();
  short_term_moving_average_fraction_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.short_term_moving_average_fraction)
}

// optional float eps = 4 [default = 1e-05];
inline bool ShortTermReNormParameter::has_eps() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ShortTermReNormParameter::set_has_eps() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ShortTermReNormParameter::clear_has_eps() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ShortTermReNormParameter::clear_eps() {
  eps_ = 1e-05f;
  clear_has_eps();
}
inline float ShortTermReNormParameter::eps() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.eps)
  return eps_;
}
inline void ShortTermReNormParameter::set_eps(float value) {
  set_has_eps();
  eps_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.eps)
}

// optional uint32 iter_size = 5 [default = 1];
inline bool ShortTermReNormParameter::has_iter_size() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ShortTermReNormParameter::set_has_iter_size() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ShortTermReNormParameter::clear_has_iter_size() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ShortTermReNormParameter::clear_iter_size() {
  iter_size_ = 1u;
  clear_has_iter_size();
}
inline ::google::protobuf::uint32 ShortTermReNormParameter::iter_size() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.iter_size)
  return iter_size_;
}
inline void ShortTermReNormParameter::set_iter_size(::google::protobuf::uint32 value) {
  set_has_iter_size();
  iter_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.iter_size)
}

// optional uint32 step_to_init = 6 [default = 1000];
inline bool ShortTermReNormParameter::has_step_to_init() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ShortTermReNormParameter::set_has_step_to_init() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ShortTermReNormParameter::clear_has_step_to_init() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ShortTermReNormParameter::clear_step_to_init() {
  step_to_init_ = 1000u;
  clear_has_step_to_init();
}
inline ::google::protobuf::uint32 ShortTermReNormParameter::step_to_init() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.step_to_init)
  return step_to_init_;
}
inline void ShortTermReNormParameter::set_step_to_init(::google::protobuf::uint32 value) {
  set_has_step_to_init();
  step_to_init_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.step_to_init)
}

// optional float r_max_increase_step = 7 [default = 0.05];
inline bool ShortTermReNormParameter::has_r_max_increase_step() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ShortTermReNormParameter::set_has_r_max_increase_step() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ShortTermReNormParameter::clear_has_r_max_increase_step() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ShortTermReNormParameter::clear_r_max_increase_step() {
  r_max_increase_step_ = 0.05f;
  clear_has_r_max_increase_step();
}
inline float ShortTermReNormParameter::r_max_increase_step() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.r_max_increase_step)
  return r_max_increase_step_;
}
inline void ShortTermReNormParameter::set_r_max_increase_step(float value) {
  set_has_r_max_increase_step();
  r_max_increase_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.r_max_increase_step)
}

// optional float d_max_increase_step = 8 [default = 0.05];
inline bool ShortTermReNormParameter::has_d_max_increase_step() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ShortTermReNormParameter::set_has_d_max_increase_step() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ShortTermReNormParameter::clear_has_d_max_increase_step() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ShortTermReNormParameter::clear_d_max_increase_step() {
  d_max_increase_step_ = 0.05f;
  clear_has_d_max_increase_step();
}
inline float ShortTermReNormParameter::d_max_increase_step() const {
  // @@protoc_insertion_point(field_get:caffe.ShortTermReNormParameter.d_max_increase_step)
  return d_max_increase_step_;
}
inline void ShortTermReNormParameter::set_d_max_increase_step(float value) {
  set_has_d_max_increase_step();
  d_max_increase_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.ShortTermReNormParameter.d_max_increase_step)
}
...
// optional bool use_global_stats = 1;
inline bool StochasticReNormParameter::has_use_global_stats() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void StochasticReNormParameter::set_has_use_global_stats() {
  _has_bits_[0] |= 0x00000001u;
}
inline void StochasticReNormParameter::clear_has_use_global_stats() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void StochasticReNormParameter::clear_use_global_stats() {
  use_global_stats_ = false;
  clear_has_use_global_stats();
}
inline bool StochasticReNormParameter::use_global_stats() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.use_global_stats)
  return use_global_stats_;
}
inline void StochasticReNormParameter::set_use_global_stats(bool value) {
  set_has_use_global_stats();
  use_global_stats_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.use_global_stats)
}

// optional float moving_average_fraction = 2 [default = 0.99];
inline bool StochasticReNormParameter::has_moving_average_fraction() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void StochasticReNormParameter::set_has_moving_average_fraction() {
  _has_bits_[0] |= 0x00000002u;
}
inline void StochasticReNormParameter::clear_has_moving_average_fraction() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void StochasticReNormParameter::clear_moving_average_fraction() {
  moving_average_fraction_ = 0.99f;
  clear_has_moving_average_fraction();
}
inline float StochasticReNormParameter::moving_average_fraction() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.moving_average_fraction)
  return moving_average_fraction_;
}
inline void StochasticReNormParameter::set_moving_average_fraction(float value) {
  set_has_moving_average_fraction();
  moving_average_fraction_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.moving_average_fraction)
}

// optional float eps = 3 [default = 1e-05];
inline bool StochasticReNormParameter::has_eps() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void StochasticReNormParameter::set_has_eps() {
  _has_bits_[0] |= 0x00000004u;
}
inline void StochasticReNormParameter::clear_has_eps() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void StochasticReNormParameter::clear_eps() {
  eps_ = 1e-05f;
  clear_has_eps();
}
inline float StochasticReNormParameter::eps() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.eps)
  return eps_;
}
inline void StochasticReNormParameter::set_eps(float value) {
  set_has_eps();
  eps_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.eps)
}

// optional uint32 iter_size = 4 [default = 1];
inline bool StochasticReNormParameter::has_iter_size() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void StochasticReNormParameter::set_has_iter_size() {
  _has_bits_[0] |= 0x00000008u;
}
inline void StochasticReNormParameter::clear_has_iter_size() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void StochasticReNormParameter::clear_iter_size() {
  iter_size_ = 1u;
  clear_has_iter_size();
}
inline ::google::protobuf::uint32 StochasticReNormParameter::iter_size() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.iter_size)
  return iter_size_;
}
inline void StochasticReNormParameter::set_iter_size(::google::protobuf::uint32 value) {
  set_has_iter_size();
  iter_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.iter_size)
}

// optional uint32 step_to_init = 5 [default = 1000];
inline bool StochasticReNormParameter::has_step_to_init() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void StochasticReNormParameter::set_has_step_to_init() {
  _has_bits_[0] |= 0x00000010u;
}
inline void StochasticReNormParameter::clear_has_step_to_init() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void StochasticReNormParameter::clear_step_to_init() {
  step_to_init_ = 1000u;
  clear_has_step_to_init();
}
inline ::google::protobuf::uint32 StochasticReNormParameter::step_to_init() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.step_to_init)
  return step_to_init_;
}
inline void StochasticReNormParameter::set_step_to_init(::google::protobuf::uint32 value) {
  set_has_step_to_init();
  step_to_init_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.step_to_init)
}

// optional float r_max_increase_step = 6 [default = 0.05];
inline bool StochasticReNormParameter::has_r_max_increase_step() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void StochasticReNormParameter::set_has_r_max_increase_step() {
  _has_bits_[0] |= 0x00000020u;
}
inline void StochasticReNormParameter::clear_has_r_max_increase_step() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void StochasticReNormParameter::clear_r_max_increase_step() {
  r_max_increase_step_ = 0.05f;
  clear_has_r_max_increase_step();
}
inline float StochasticReNormParameter::r_max_increase_step() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.r_max_increase_step)
  return r_max_increase_step_;
}
inline void StochasticReNormParameter::set_r_max_increase_step(float value) {
  set_has_r_max_increase_step();
  r_max_increase_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.r_max_increase_step)
}

// optional float d_max_increase_step = 7 [default = 0.05];
inline bool StochasticReNormParameter::has_d_max_increase_step() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void StochasticReNormParameter::set_has_d_max_increase_step() {
  _has_bits_[0] |= 0x00000040u;
}
inline void StochasticReNormParameter::clear_has_d_max_increase_step() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void StochasticReNormParameter::clear_d_max_increase_step() {
  d_max_increase_step_ = 0.05f;
  clear_has_d_max_increase_step();
}
inline float StochasticReNormParameter::d_max_increase_step() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.d_max_increase_step)
  return d_max_increase_step_;
}
inline void StochasticReNormParameter::set_d_max_increase_step(float value) {
  set_has_d_max_increase_step();
  d_max_increase_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.d_max_increase_step)
}

// optional float mean_rng = 8 [default = 0.1];
inline bool StochasticReNormParameter::has_mean_rng() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void StochasticReNormParameter::set_has_mean_rng() {
  _has_bits_[0] |= 0x00000080u;
}
inline void StochasticReNormParameter::clear_has_mean_rng() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void StochasticReNormParameter::clear_mean_rng() {
  mean_rng_ = 0.1f;
  clear_has_mean_rng();
}
inline float StochasticReNormParameter::mean_rng() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.mean_rng)
  return mean_rng_;
}
inline void StochasticReNormParameter::set_mean_rng(float value) {
  set_has_mean_rng();
  mean_rng_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.mean_rng)
}

// optional float std_rng = 9 [default = 0.03];
inline bool StochasticReNormParameter::has_std_rng() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void StochasticReNormParameter::set_has_std_rng() {
  _has_bits_[0] |= 0x00000100u;
}
inline void StochasticReNormParameter::clear_has_std_rng() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void StochasticReNormParameter::clear_std_rng() {
  std_rng_ = 0.03f;
  clear_has_std_rng();
}
inline float StochasticReNormParameter::std_rng() const {
  // @@protoc_insertion_point(field_get:caffe.StochasticReNormParameter.std_rng)
  return std_rng_;
}
inline void StochasticReNormParameter::set_std_rng(float value) {
  set_has_std_rng();
  std_rng_ = value;
  // @@protoc_insertion_point(field_set:caffe.StochasticReNormParameter.std_rng)
}
...
// optional bool use_global_stats = 1;
inline bool BatchReNormParameter::has_use_global_stats() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BatchReNormParameter::set_has_use_global_stats() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BatchReNormParameter::clear_has_use_global_stats() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BatchReNormParameter::clear_use_global_stats() {
  use_global_stats_ = false;
  clear_has_use_global_stats();
}
inline bool BatchReNormParameter::use_global_stats() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.use_global_stats)
  return use_global_stats_;
}
inline void BatchReNormParameter::set_use_global_stats(bool value) {
  set_has_use_global_stats();
  use_global_stats_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.use_global_stats)
}

// optional float moving_average_fraction = 2 [default = 0.99];
inline bool BatchReNormParameter::has_moving_average_fraction() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BatchReNormParameter::set_has_moving_average_fraction() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BatchReNormParameter::clear_has_moving_average_fraction() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BatchReNormParameter::clear_moving_average_fraction() {
  moving_average_fraction_ = 0.99f;
  clear_has_moving_average_fraction();
}
inline float BatchReNormParameter::moving_average_fraction() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.moving_average_fraction)
  return moving_average_fraction_;
}
inline void BatchReNormParameter::set_moving_average_fraction(float value) {
  set_has_moving_average_fraction();
  moving_average_fraction_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.moving_average_fraction)
}

// optional float eps = 3 [default = 1e-05];
inline bool BatchReNormParameter::has_eps() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BatchReNormParameter::set_has_eps() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BatchReNormParameter::clear_has_eps() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BatchReNormParameter::clear_eps() {
  eps_ = 1e-05f;
  clear_has_eps();
}
inline float BatchReNormParameter::eps() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.eps)
  return eps_;
}
inline void BatchReNormParameter::set_eps(float value) {
  set_has_eps();
  eps_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.eps)
}

// optional uint32 iter_size = 4 [default = 1];
inline bool BatchReNormParameter::has_iter_size() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void BatchReNormParameter::set_has_iter_size() {
  _has_bits_[0] |= 0x00000008u;
}
inline void BatchReNormParameter::clear_has_iter_size() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void BatchReNormParameter::clear_iter_size() {
  iter_size_ = 1u;
  clear_has_iter_size();
}
inline ::google::protobuf::uint32 BatchReNormParameter::iter_size() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.iter_size)
  return iter_size_;
}
inline void BatchReNormParameter::set_iter_size(::google::protobuf::uint32 value) {
  set_has_iter_size();
  iter_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.iter_size)
}

// optional uint32 step_to_init = 5 [default = 1000];
inline bool BatchReNormParameter::has_step_to_init() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void BatchReNormParameter::set_has_step_to_init() {
  _has_bits_[0] |= 0x00000010u;
}
inline void BatchReNormParameter::clear_has_step_to_init() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void BatchReNormParameter::clear_step_to_init() {
  step_to_init_ = 1000u;
  clear_has_step_to_init();
}
inline ::google::protobuf::uint32 BatchReNormParameter::step_to_init() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.step_to_init)
  return step_to_init_;
}
inline void BatchReNormParameter::set_step_to_init(::google::protobuf::uint32 value) {
  set_has_step_to_init();
  step_to_init_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.step_to_init)
}

// optional uint32 step_to_r_max = 6 [default = 10000];
inline bool BatchReNormParameter::has_step_to_r_max() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void BatchReNormParameter::set_has_step_to_r_max() {
  _has_bits_[0] |= 0x00000020u;
}
inline void BatchReNormParameter::clear_has_step_to_r_max() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void BatchReNormParameter::clear_step_to_r_max() {
  step_to_r_max_ = 10000u;
  clear_has_step_to_r_max();
}
inline ::google::protobuf::uint32 BatchReNormParameter::step_to_r_max() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.step_to_r_max)
  return step_to_r_max_;
}
inline void BatchReNormParameter::set_step_to_r_max(::google::protobuf::uint32 value) {
  set_has_step_to_r_max();
  step_to_r_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.step_to_r_max)
}

// optional uint32 step_to_d_max = 7 [default = 10000];
inline bool BatchReNormParameter::has_step_to_d_max() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void BatchReNormParameter::set_has_step_to_d_max() {
  _has_bits_[0] |= 0x00000040u;
}
inline void BatchReNormParameter::clear_has_step_to_d_max() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void BatchReNormParameter::clear_step_to_d_max() {
  step_to_d_max_ = 10000u;
  clear_has_step_to_d_max();
}
inline ::google::protobuf::uint32 BatchReNormParameter::step_to_d_max() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.step_to_d_max)
  return step_to_d_max_;
}
inline void BatchReNormParameter::set_step_to_d_max(::google::protobuf::uint32 value) {
  set_has_step_to_d_max();
  step_to_d_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.step_to_d_max)
}

// optional float r_max = 8 [default = 3];
inline bool BatchReNormParameter::has_r_max() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void BatchReNormParameter::set_has_r_max() {
  _has_bits_[0] |= 0x00000080u;
}
inline void BatchReNormParameter::clear_has_r_max() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void BatchReNormParameter::clear_r_max() {
  r_max_ = 3;
  clear_has_r_max();
}
inline float BatchReNormParameter::r_max() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.r_max)
  return r_max_;
}
inline void BatchReNormParameter::set_r_max(float value) {
  set_has_r_max();
  r_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.r_max)
}

// optional float d_max = 9 [default = 5];
inline bool BatchReNormParameter::has_d_max() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void BatchReNormParameter::set_has_d_max() {
  _has_bits_[0] |= 0x00000100u;
}
inline void BatchReNormParameter::clear_has_d_max() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void BatchReNormParameter::clear_d_max() {
  d_max_ = 5;
  clear_has_d_max();
}
inline float BatchReNormParameter::d_max() const {
  // @@protoc_insertion_point(field_get:caffe.BatchReNormParameter.d_max)
  return d_max_;
}
inline void BatchReNormParameter::set_d_max(float value) {
  set_has_d_max();
  d_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.BatchReNormParameter.d_max)
}
...
// optional uint32 pair_size = 13 [default = 1];
inline bool ImageDataParameter::has_pair_size() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ImageDataParameter::set_has_pair_size() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ImageDataParameter::clear_has_pair_size() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ImageDataParameter::clear_pair_size() {
  pair_size_ = 1u;
  clear_has_pair_size();
}
inline ::google::protobuf::uint32 ImageDataParameter::pair_size() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.pair_size)
  return pair_size_;
}
inline void ImageDataParameter::set_pair_size(::google::protobuf::uint32 value) {
  set_has_pair_size();
  pair_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.pair_size)
}

// optional float num_labels = 14 [default = 1];
inline bool ImageDataParameter::has_num_labels() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ImageDataParameter::set_has_num_labels() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ImageDataParameter::clear_has_num_labels() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ImageDataParameter::clear_num_labels() {
  num_labels_ = 1;
  clear_has_num_labels();
}
inline float ImageDataParameter::num_labels() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.num_labels)
  return num_labels_;
}
inline void ImageDataParameter::set_num_labels(float value) {
  set_has_num_labels();
  num_labels_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.num_labels)
}

// optional float object_scale = 15 [default = 1];
inline bool ImageDataParameter::has_object_scale() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ImageDataParameter::set_has_object_scale() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ImageDataParameter::clear_has_object_scale() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ImageDataParameter::clear_object_scale() {
  object_scale_ = 1;
  clear_has_object_scale();
}
inline float ImageDataParameter::object_scale() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.object_scale)
  return object_scale_;
}
inline void ImageDataParameter::set_object_scale(float value) {
  set_has_object_scale();
  object_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.object_scale)
}
...
// optional uint32 neg_num = 1 [default = 1];
inline bool RankHardLossParameter::has_neg_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RankHardLossParameter::set_has_neg_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RankHardLossParameter::clear_has_neg_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RankHardLossParameter::clear_neg_num() {
  neg_num_ = 1u;
  clear_has_neg_num();
}
inline ::google::protobuf::uint32 RankHardLossParameter::neg_num() const {
  // @@protoc_insertion_point(field_get:caffe.RankHardLossParameter.neg_num)
  return neg_num_;
}
inline void RankHardLossParameter::set_neg_num(::google::protobuf::uint32 value) {
  set_has_neg_num();
  neg_num_ = value;
  // @@protoc_insertion_point(field_set:caffe.RankHardLossParameter.neg_num)
}

// optional uint32 pos_num = 2 [default = 1];
inline bool RankHardLossParameter::has_pos_num() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RankHardLossParameter::set_has_pos_num() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RankHardLossParameter::clear_has_pos_num() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RankHardLossParameter::clear_pos_num() {
  pos_num_ = 1u;
  clear_has_pos_num();
}
inline ::google::protobuf::uint32 RankHardLossParameter::pos_num() const {
  // @@protoc_insertion_point(field_get:caffe.RankHardLossParameter.pos_num)
  return pos_num_;
}
inline void RankHardLossParameter::set_pos_num(::google::protobuf::uint32 value) {
  set_has_pos_num();
  pos_num_ = value;
  // @@protoc_insertion_point(field_set:caffe.RankHardLossParameter.pos_num)
}

// optional float margin = 3 [default = 0.5];
inline bool RankHardLossParameter::has_margin() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void RankHardLossParameter::set_has_margin() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RankHardLossParameter::clear_has_margin() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RankHardLossParameter::clear_margin() {
  margin_ = 0.5f;
  clear_has_margin();
}
inline float RankHardLossParameter::margin() const {
  // @@protoc_insertion_point(field_get:caffe.RankHardLossParameter.margin)
  return margin_;
}
inline void RankHardLossParameter::set_margin(float value) {
  set_has_margin();
  margin_ = value;
  // @@protoc_insertion_point(field_set:caffe.RankHardLossParameter.margin)
}
